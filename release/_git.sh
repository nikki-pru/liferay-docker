...
function update_release_tool_repository {
	...
	local release_tool_sha="31f14cd14ac548175217ddd500e873618187af69"
	...
	then
		lc_log INFO "Remote 'tinatian' already exists. Skipping..."
	else
		lc_log INFO "Remote 'tinatian' not found. Adding it now..."
	...
	git checkout LPD-79898-4

	git pull tinatian LPD-79898-4
